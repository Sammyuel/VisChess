...
exports.default = {
  ...
  aliases: ['login'],
  flags: [{ name: 'browser', description: 'browser to open SSO with' }, { name: 'sso', description: 'login for enterprise users under SSO' }, { name: 'expires-in', char: 'e', description: 'duration of token in seconds', hasValue: true }],
